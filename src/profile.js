...
Whelp. This little journal sesh was fun, but it's 12:55 AM, and I have class in about seven and half hours. I really need to stop procrastinating on sleep. I don't know what wrong it ever did me. </p>
						    <Row>
						    	<Col style={{textAlign: 'center'}} sm={4} xs={2}><a href='https://github.com/phill117'><i className="fa fa-github-square fa-4x profIcon"></i></a></Col>
						    	<Col style={{textAlign: 'center'}} sm={4} xs={2}><a href='https://www.linkedin.com/in/sphillips117'><i className="fa fa-linkedin-square fa-4x profIcon"></i></a></Col>
						    	<Col style={{textAlign: 'center'}} sm={4} xs={2}><a href='mailto:contact@seanphillips.me'><i className="fa fa-envelope-square fa-4x profIcon"></i></a></Col>
						    </Row>
			    		</Col>
			    	</Row>
			    </Grid>
